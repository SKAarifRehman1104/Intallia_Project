      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-[#F9FAFB]">
            ...
            <TableHead className="text-sm">PackageCategory</TableHead>
            ...
            <TableRow key={payment.id} className="text-sm">
              <TableCell className="py-4 text-sm">
                <input
                  ...
                  onChange={() => handleSelectUser(payment.id)}
                />
              </TableCell>
              <TableCell className="py-4 text-sm">
                <Link to={`/plan/${payment.id}`} className="text-blue-600">
                  {payment.id}
                </Link>
              </TableCell>
              <TableCell className="py-4 text-sm">{payment.name}</TableCell>
              <TableCell className="py-4 text-sm">{payment.email}</TableCell>
              <TableCell className="py-4 text-sm">{payment.date}</TableCell>
              <TableCell className="py-4 text-sm">
