...
const Education: React.FC = () => {
  return (
    <div className="bg-white overflow-hidden pb-[90px] max-md:w-full max-md:ml-0">
      <Header />
      <div className="flex w-full flex-col ml-[129px] mt-[55px] max-md:max-w-full max-md:mt-10">
          ...
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
            ...
            <div className="w-[72%] ml-5 max-md:w-full max-md:ml-0">
              <div className="flex grow flex-col items-stretch max-md:max-w-full max-md:mt-10">
                ...
                <EducationForm />
                <div className="flex justify-end gap-4 mt-8 w-[72%] ml-5 max-md:w-full max-md:ml-0">
                  <CustomButton
                    variant="secondary"
