...
export const EducationSection: React.FC<EducationSectionProps> = ({
  ...
  const handleAdd = () => {
    ...
    setEducations([...educations, { id: newId, school: `Education ${educations.length + 1}` }]);
  };
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <button onClick={() => toggleCollapse(education.id)}>
                  <ChevronDown className={cn("w-6 h-6 transition-transform", education.collapsed && "rotate-180")} />
                </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-6">
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-1">
                    ...
                    <span className="text-[#010000] text-sm">*</span>
                  </label>
                  <input
                    type="text"
